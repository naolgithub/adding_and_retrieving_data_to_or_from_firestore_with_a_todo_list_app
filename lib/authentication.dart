import 'package:adding_and_retrieving_data_to_or_from_firestore_with_a_todo_list_app/services.dart';
...
class HomeAuthentication extends StatefulWidget {
  ...
  @override
  _HomeAuthenticationState createState() => _HomeAuthenticationState();
}

class _HomeAuthenticationState extends State<HomeAuthentication> {
  // firebase
    ...
    try {
      ...
      if (user != null) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text((loggedInUser.email).toString()),
          ),
        );
      }
    } catch (e) {
